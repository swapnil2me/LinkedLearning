...
var firstGroup = chartGroup.selectAll("g")
                            .data(data)
                            .enter().append("g")
...
var secondGroup = firstGroup.selectAll("g")
                            .data(function(d){return d;})
                            .enter().append("g")
                              .attr("class",function(d,i){return "secondLevelGroup"+i;})
                              .attr("transform",function (d,i) {
                                return "translate(0,"+(height-((i+1)*50))+")";
                              });

// Equally valid for adding rect
...
secondGroup.selectAll("circle")
  .data(function(d){return d;})
  .enter().append("circle")
  .filter(function(d){return d>10;})//filtering circles by a condition
